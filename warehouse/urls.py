...
from storage.views import get_reason_choices, get_product_data, \
    NamesAutocomplete, get_model_fields, get_saved_fields, UserAutocomplete
...
urlpatterns = [
    ...
    path('names-autocomplete/', NamesAutocomplete.as_view(), name='names-autocomplete'),
